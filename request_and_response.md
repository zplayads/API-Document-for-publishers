...
| hmin     | int         |      |                                                               |
| btype    | int 数组    |      |                                                               |
| battr    | int 数组    |      | 不支持的创意类型                                              |
| pos      | int         | 否   | 广告位位置，1：；4：；5：；6：；7：                           |
| mimes    | string 数组 | 是   | 请填写您支持的物料格式，“text/html”，“image/jpg”，“image/png” |
| api      | int 数组    | 否   |                                                               |
...
| 字段名称    | 类型 | 必须 | 描述                                                                           |
| ----------- | ---- | ---- | ------------------------------------------------------------------------------ |
| mimes       | 数组 | 是   | 填写您支持的视频格式，如"mimes":["video、mp4"]，目前 ZPLAY Ads 只支持 MP4 格式 |
...
| adm               | string | 否   | 若请求中 video 对象有值，且支持 VAST 协议时，此字段有值                                                                                                                                                                                                                |
