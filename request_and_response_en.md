...
| support_function | bool            | Y         | Whether support close event and install event in third and forth part of [Check_list](/check_list_en.md); 0: not support, 1: support; Publisher should handle both close event and install event if does not support these two events we provide |
